...
def EEGNet(nb_classes, Chans=64, Samples=128,
    ...
    Inputs:
      ...
      filter = half the sampling rate
      kernel = 1/4 of the sampling rate

      C = number of channels, T = number of time points, F1 =number of temporal filters,
      D = depth multiplier (number of spatial filters), F2 = number of pointwise filters, and N = number of classes
...
def cnnlstm(nb_classes, Chans, Samples, dropoutRate=0.5, weight_decay=1):
    ...
    block1 = Conv2D(64, (1, 64), padding='same', kernel_regularizer=regularizers.l2(weight_decay),
                    input_shape=(Chans, Samples, 1),
    ...
    reshape1 = Reshape((128, 128))(block1)
